...
def _load_dotenv() -> None:
    """Read repo-root .env into the environment without overwriting real vars.

    Kept dependency-free and deliberately dumb: no interpolation, no export
    syntax. `.env` is gitignored -- keys must never reach the repo.
    """
